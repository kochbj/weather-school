...
function calculatedSolarDataFetch( evt ) {
	...
	for (mid in this.markers) {
		...
		var dataPoints = {
			...
			sunEnergyT : { type : 'float' , label : 'Energy from the sun (theoretical)' , labelShort : 'Theoretical energy (W-h/m<sup>2</sup>/d)' , range : [0,10000] , format : function ( val ) { return Math.round( val ) + ' Watt-hours per meter<sup>2</sup> per day'; } },
