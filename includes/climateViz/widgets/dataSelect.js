...
function calculatedSolarDataFetch( evt ) {
	...
	for (mid in this.markers) {
		...
		var dataPoints = {
			...
			sunAngle : { type : 'float' , label : 'Maximum height of sun in sky' , labelShort : 'Max height of sun (°)', tooltip:'Max height sun', range : [0,90] , format : function ( val ) { return Math.round( val ) + '°' ; } },
			...
			sunEnergyT : { type : 'float' , label : 'Daily theoretical energy from sun<br>(W-h/m<sup>2</sup>/d)' , labelShort : 'Energy from sun (theoretical)' , tooltip: 'Theo energy', range : [0,10000] , format : function ( val ) { return Math.round( val ) + ' Watt-hours per meter<sup>2</sup> per day'; } },
