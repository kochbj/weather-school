<div id="introduction" data-slide-type="key" data-slide-title="Introduction">
...
<div id="sun-position">
	...
	<table>
		<tr>
			<td><img src="<?php echo CLIMATE_DIR_WWW; ?>/includes/media/position/sun-in-winter.jpg"><div class="caption">Less energy reaches the earth at this place</div></td>
		...
		<tr>
			<td><img src="<?php echo CLIMATE_DIR_WWW; ?>/includes/media/position/sun-in-summer.jpg"><div class="caption">More energy reaches the earth at this place</div></td>
...
<div id="locationExplorer-sample" class="activity" data-slide-type="key" data-slide-title="Location Summary">
	<div class="header">
		<h2>Introducing ...</h2>
	</div>
	<div class="workarea">
...
<div id="temperature-intro" data-slide-type="key" data-slide-title="Temperature Patterns">
...
<div id="temperature-lat" class="activity" data-slide-type="key" data-slide-title="Temperature and Lattitude">
	<div class="header">
...
<div id="temperature-elev-intro" data-slide-type="key" data-slide-title="Temperature and Elevation">
...
<div id="temperature-water-intro" data-slide-type="key" data-slide-title="Temperature and Water">
...
<div id="daylight-intro" class="activity" data-slide-type="key" data-slide-title="Hours of Daylight">
	<div class="header">
...
<div id="relationships-intro" data-slide-type="key" data-slide-title="Relationships Between Variables">
...
<div id="models-intro" data-slide-type="key" data-slide-title="Models">
...
<div id="models-motion4" class="activity">
	...
	<div class="instructions">
		...
		<div class="questionBox">
			<form onclick="return false;">
			<ol class="questions">
				<li><label for="models-motion4-q1">What  is the maximum height of the sun in the sky on June 22 at the equator?</label> <input type="text" id="models-motion4-q1" name="models-motion4-q1"></li>
				<li><label for="models-motion4-q2">At  what latitude does the sun strike the earth at a 90 degree angle on June 22?</label> <input type="text" id="models-motion4-q2" name="models-motion4-q2"></li>
			</ol>
			</form>
		</div>
	</div>
...
<div id="models-motion5" class="activity">
	...
	<div class="instructions">
		...
		<div class="questionBox">
			<form onclick="return false;">
			<ol class="questions">
				<li><label for="models-motion5-q1">What  is the maximum height of the sun in the sky on September 22 at the equator?</label> <input type="text" id="models-motion5-q1" name="models-motion5-q1"></li>
				<li><label for="models-motion5-q2">At  what latitude does the sun strike the earth at a 90 degree angle on September  22?</label> <input type="text" id="models-motion5-q2" name="models-motion5-q2"></li>
			</ol>
			</form>
		</div>
	</div>
...
<div id="models-motion6" class="activity">
	...
	<div class="instructions">
		...
		<div class="questionBox">
			<form onclick="return false;">
			<ol class="questions">
				<li><label for="models-motion6-q1">What  is the maximum height of the sun in the sky on December 22 at the equator?</label> <input type="text" id="models-motion6-q1" name="models-motion6-q1"></li>
				<li><label for="models-motion6-q2">At  what latitude does the sun strike the earth at a 90 degree angle on December 22?</label> <input type="text" id="models-motion6-q2" name="models-motion6-q2"></li>
			</ol>
			</form>
		</div>
	</div>
...
<div id="models-motion7" class="activity">
	...
	<div class="instructions">
		...
		<div class="questionBox">
			<form onclick="return false;">
			<ol class="questions">
					<li><label for="models-motion7-q1">Where  is the sun directly overhead on the first day of summer in the northern  hemisphere?</label> <input type="text" id="models-motion7-q1" name="models-motion7-q1"></li>
			</ol>
			</form>
		</div>
	</div>
...
<div id="models-motion8" class="activity">
	...
	<div class="instructions">
		...
		<div class="questionBox">
			...
			<ol class="questions">
				<li><label for="models-motion8-q1">On  what line of latitude is the sun directly overhead on March 22, the first day  of spring in the northern hemisphere?</label> <input type="text" id="models-motion8-q1" name="models-motion8-q1"></li>
				<li><label for="models-motion8-q2">On  what line of latitude is the sun directly overhead on June 22, the first day of  summer in the northern hemisphere?</label> <input type="text" id="models-motion8-q2" name="models-motion8-q2"></li>
				<li><label for="models-motion8-q3">On  what line of latitude is the sun directly overhead on September 22, the first  day of fall in the northern hemisphere?</label> <input type="text" id="models-motion8-q3" name="models-motion8-q3"></li>
				<li><label for="models-motion8-q4">On  what line of latitude is the sun directly overhead on December 22, the first  day of winter in the northern hemisphere?</label> <input type="text" id="models-motion8-q4" name="models-motion8-q4"></li>
			</ol>
			</form>
		</div>
	</div>
...
<div id="models-motion12" class="activity">
	...
	<div class="instructions">
		...
		<div class="questionBox">
			<form onclick="return false;">
			<ol class="questions">
				<li><label for="models-motion12-q1">At what angle do the sun&rsquo;s rays strike the earth on  the first day of fall at 39o N latitude? Go to the tables tab  to find out what that angle is.  As you  did before, choose Washington, DC as your location, and choose September 22 as  your date.  What is the maximum angle of  the sun in the sky on September 22, the first day of fall in the northern  hemisphere?</label> <input type="text" id="models-motion12-q1" name="models-motion12-q1"></li>
				<li>Now  list the maximum angle that the sun reaches for the four dates that you  explored:
				<ul>
					<li><label for="models-motion12-q2">What is the maximum angle for the first day of  winter?</label> <input type="text" id="models-motion12-q2" name="models-motion12-q2"></li>
					<li><label for="models-motion12-q3">What is the maximum angle for the first day of  spring?</label> <input type="text" id="models-motion12-q3" name="models-motion12-q3"></li>
					<li><label for="models-motion12-q4">What is the maximum angle for the first day of  summer?</label> <input type="text" id="models-motion12-q4" name="models-motion12-q4"></li>
					<li><label for="models-motion12-q5">What is the maximum angle for the first day of  fall?</label> <input type="text" id="models-motion12-q5" name="models-motion12-q5"></li>
				</ul>
				</li>
				<li><label for="models-motion12-q6">Do  you think there is any day during the year when the sun is directly overhead at  39o N latitude?</label> <input type="text" id="models-motion12-q6" name="models-motion12-a6"></li>
				<li><label for="models-motion12-q7">How  far north can a place be and have the sun be 90 degrees overhead?</label> <input type="text" id="models-motion12-q6" name="models-motion12-q6"></li>
			</ol>
			</form>
		</div>
	</div>
...
<div id="models-motion13" class="activity">
	...
	<div class="instructions">
		...
		<div class="questionBox">
			<form onclick="return false;">
			<ol class="questions">
				<li><label for="models-motion13-q1">What  happens to the maximum height of the sun in the sky as you move farther away  from the tropical zone and closer to the North Pole?</label> <input type="text" id="models-motion13-q1" name="models-motion13-q1"></li>
					<li><label for="models-motion13-q2">Is that true all times of the year or just some  times of the year?</label> <input type="text" id="models-motion13-q2" name="models-motion13-q2"></li>
				<li><label for="models-motion13-q3">What  happens to the maximum height of the sun in the sky as you move farther away  from the tropical zone and closer to the South Pole?</label> <input type="text" id="models-motion13-q3" name="models-motion13-q1"></li>
					<li><label for="models-motion13-q4">Is that true all times of the year or just some  times of the year?</label> <input type="text" id="models-motion13-q4" name="models-motion13-q4"></li>
				<li><label for="models-motion13-q5">What  happens to the maximum height of the sun in the sky the farther you are away  from the place where the sun is directly overhead?</label> <input type="text" id="models-motion13-q5" name="models-motion13-q5"></li>
