...
<div id="daylight-air-temperature-example" class="activity" data-slide-type="normal" data-slide-title="Step By Step: Hours of Daylight and Air Temperature" data-slide-parent-id="daylight-air-temperature-intro">
	...
	<div class="instructions">
		<div class="slider">
			<div>	<p>Are air temperature and the number of hours of daylight at a given place related? This activity looks at average daily air temperature and the number of hours of daylight for 12 specific dates in Chicago, Illinois to find out.</p></div>
...
<div id="data-tools-intro" class="module-intro" data-slide-type="key" data-slide-title="Introduction" data-slide-group-title="Additional Data Tools">
	...
	<div class="intro-text">
	<p>In this section you can use the <b>Variable Relationship Explorer</b>, the <b>Daylight Hours Explorer</b>, and the <b>Seasons Simulator</b> to continue to find patterns in data as well as explore the causes of some patterns you previously identified.</p>
	<p><b>Variable Relationship Explorer</b></p>
	<p>In the previous modules, you learned how factors, such as elevation, proximity to water, maximum height of the sun in the sky, and hours of daylight are related to air temperature. You can use the Variable Relationship Explorer to continue to explore how different weather factors are related to each other and to air temperature.</p>
	
	<p><b>Seasons Simulator</b></p>
 <p>In the previous modules, you also learned how factors such as air temperature, maximum height of the sun in the sky, and number of hours of daylight change in a regular pattern over the course of the year. You can use the Seasons Simulator to see how the earth’s position relative to the sun also changes in a regular pattern throughout the year. The changing position of the earth relative to the sun causes many of the patterns you previously explored.</p> 
 	<p><b>Daylight Hours Explorer</b></p>
 	<p>Use the Daylight Hours Explorer to visualize how the number of hours of daylight changes throughout the year at different degrees of latitude.</p>
...
<div id="vis-sim-eliptic-intro" class="activity" data-slide-type="tool" data-slide-title="Seasons and Ecliptic Simulator" data-slide-parent-id="data-tools-intro">
	...
	<p style="margin-left: 15px;">Place the stick figure at a latitude between 25 and 50 degrees latitude. Start the animation to change the date shown in the animations. Notice that the angle that the sun's rays hit the earth changes throughout the year. This angle corresponds to changing heights of the sun in the sky.</p>
	<p style="margin-left: 15px;">Why is the height of the sun in the sky related to air temperature?</p>
	<p style="margin-left: 15px;">Place the stick figure around 50 degrees north. Start the animation. Stop the animation in November or December. Notice that the sun's rays hit the earth at a very small angle and the distance between the rays is very large. When the height of the sun in the sky is very low, the intensity of the sun's rays hitting the earth is smaller. This causes less solar energy to reach the earth. Therefore, the air temperature is lower. </p>
</div>
</div>
