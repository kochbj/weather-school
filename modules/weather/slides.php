...
<div id="height-sun-complete" class="module-complete" data-slide-type="contents" data-slide-title="Module Complete" data-slide-parent-id="height-sun-intro">
	...
	<div class="guiding-questions">
		...
		<h2>Expand Your Knowledge</h2>	
		<p>PUse the <a href="http://weatherschool.aaas.org/modules/weather/#vis-sim-eliptic"target="_blank">Earth-Sun Simulator</a>, to see how the location of the earth at different times of the year causes the maximum angle of the sun in the sky to change in a cyclical pattern.</p>
	</div>
</div>
